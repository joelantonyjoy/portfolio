...
export function Home(){
    return (
        <div style={{padding:8,paddingTop:'5vh'}}>
            <h1>Welcome</h1>
            <h1 style={{color:'red'}}>Joel Antony Joy</h1>
            <h3>Software Engineer / Full Stack Developer</h3>
            <p style={{width:'33%',minWidth:'288px',lineHeight:'24px',margin:'32px 0'}}>I am a Software Engineer with more than 1.6 years of experience in building responsive dynamic web applications with latest web technologies. 
